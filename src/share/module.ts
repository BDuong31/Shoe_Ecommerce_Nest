...
import { ADDRESS_RPC, EVENT_PUBLISHER, ORDER_RPC, PAYMENT_RPC, PRODUCT_RPC, RATING_RPC, SHIPPING_RPC, TOKEN_INTROSPECTOR, USER_RPC, VARIANT_RPC,  } from "./di-token";
import { TokenIntrospectRPCClient, UserRPCClient, AddressRPCClient, ProductRPCClient, VariantRPCClient, RatingRPCClient, OrderRPCClient, PaymentRPCClient, ShippingRPCClient } from "./rpc";
...
// Tạo module chia sẻ
@Module({
  providers: [tokenIntrospector, userRPC, addressRPC, productRPC, variantRPC, ratingRPC, orderRPC, paymentRPC, shippingRPC, redisClient],
  exports: [tokenIntrospector, userRPC, addressRPC, productRPC, variantRPC, ratingRPC, orderRPC, paymentRPC, shippingRPC, redisClient]
})
